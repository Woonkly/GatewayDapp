...
const addresswop='0x42699A7612A82f1d9C36148af9C77354759b210b';
var w3;
var contractwop;
...
window.addEventListener('load', async () => {
    ...
    if (window.web3) {
        ...
        w3 = new Web3(new Web3.providers.HttpProvider("http://217.160.75.229:8545"));
    ...
    contractwop.defaultAccount = "0xFE3B557E8Fb62b89F4916B721be55cEb828dBd73";
    refreshBalances();
});
